        ...
        <>
            <div className='mb-10 max-w-screen-2xl p-6'>
                <div className='mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                    <h2 className="text-2xl font-semibold text-black">Feed Information</h2>
                    <nav>
                        <ol className="flex items-center gap-2">
                            <li><a className="font-medium" href="/">Task / Feed /</a></li>
                            <li className="font-medium text-main">Feed Information</li>
                        </ol>
                    </nav>
                </div>
...
export default ManagementFeedAdmin;
