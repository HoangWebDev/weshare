...
const classesNavbar = 'text-sm p-1 rounded';
...
export const CloseSearchIcon = ({ className }: IconProps) => (
...
export const BellIcon = ({ width = '30px', height = '30px' }: IconProps) => (
    <svg
        width={width}
        height={height}
        className="text-gray-500 rounded-md p-1 bg-gray-300"
        role="img"
...
export const BookMarkIcon = ({ width = '30px', height = '30px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PersonIcon = ({ width = '30px', height = '30px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
//Icons posts
export const ClosePostIcon = ({ width, height, className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const HeartIcon = ({ width, height, className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const CommentIcon = ({ width, height, className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const ShareIcon = ({ width, height, className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
